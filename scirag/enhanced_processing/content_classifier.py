...
class ContentClassifier:
    ...
    def classify_content(self, text: str, metadata: Dict[str, Any]) -> ContentType:
        """
    ...
    def get_confidence_score(self, text: str, content_type: ContentType) -> float:
        """
    ...
    def classify_with_confidence(self, text: str, metadata: Dict[str, Any]) -> tuple[ContentType, float]:
        """
