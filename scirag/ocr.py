"""
    ...
    Classes/Functions:
        - MistralOCRProcessor (line 36):
            - process_single_pdf(pdf_path: str, save_markdown: bool = True, save_json: bool = True, output_dir=None) -> Dict[str, Any] (line 45)
            - _extract_structured_content(ocr_response, pdf_name: str) -> Dict[str, Any] (line 110)
            - save_to_json(data: Dict[str, Any], output_path: str) -> None (line 178)
            - save_to_markdown(data: Dict[str, Any], output_path: str) -> None (line 188)
            - save_to_text(data: Dict[str, Any], output_path: str) -> None (line 202)
